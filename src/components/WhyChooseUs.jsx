...
//                   className={`w-full text-left p-6 rounded-2xl border flex items-center gap-6 relative overflow-hidden transition-all duration-500 group ${
//                     isSelected
...
//                   <div
//                     className={`text-xl p-4 rounded-xl border transition-all duration-500 flex items-center justify-center shrink-0 ${
//                       isSelected
...
//                         isSelected ? "text-cyan-400" : "text-neutral-300 group-hover:text-white"
//                       }`}
//                     >
//                       {feat.title}
//                     </h3>
